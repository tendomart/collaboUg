...
@Transactional
public class TblUsersServiceImpl implements ItemService<TblUsers> {
	private static final Logger log = LogManager.getLogger("com.collabo.service.users.TblUsersServiceImpl");
	@Autowired
	TblUsersDaoRepo us;

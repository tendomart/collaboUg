...
@Entity
@Table(name = "tblCurrencyTypes")
public class TblCurrencyTypes extends Inserted implements Serializable {
	
	public TblCurrencyTypes() {
	}

	public TblCurrencyTypes(int id, @Size(max = 45) String cTypeName, @Size(max = 100) String cTypeDescription) {
		super();
		this.id = id;
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6295927095393831008L;
	...
	@Size(max = 45)
	@Column(name = "cTypeName", nullable = true)
	private String cTypeName;
	
	@Size(max = 100)
	@Column(name = "cTypeDescription", nullable = true)
